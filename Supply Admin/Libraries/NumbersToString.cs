...
namespace Supply_Admin.Libraries
{
    public class NumbersToString
    {
        ...
        public static string Str(int val)
        {
            ...
            if (0 == n) r.Append("0 ");
            if (n % 1000 != 0)
                r.Append(NumbersToString.Str(n, true, "", "", ""));

            n /= 1000;

            r.Insert(0, NumbersToString.Str(n, false, "тысяча", "тысячи", "тысяч"));
            n /= 1000;

            r.Insert(0, NumbersToString.Str(n, true, "миллион", "миллиона", "миллионов"));
            n /= 1000;

            r.Insert(0, NumbersToString.Str(n, true, "миллиард", "миллиарда", "миллиардов"));
            n /= 1000;

            r.Insert(0, NumbersToString.Str(n, true, "триллион", "триллиона", "триллионов"));
            n /= 1000;

            r.Insert(0, NumbersToString.Str(n, true, "триллиард", "триллиарда", "триллиардов"));
